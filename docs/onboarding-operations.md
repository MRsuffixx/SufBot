...
default). Retention cleanup should follow the platform privacy policy. PostgreSQL backups must be
encrypted and restore-tested; Redis captcha data does not require backup.
